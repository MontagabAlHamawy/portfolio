...
!(function (a) {
  ...
  var text=[" Let your dream seek the stars. If you cannot achieve it, you will reach the moon"];
  var inde=1;
  var f=0;
  var b = document.getElementById("bbb");
  function write(){
    if(inde < text[0].length){
      b.textContent +=text[0].charAt(inde);
      inde++;
...
function dell(){
  if(inde > 0){
    b.textContent =text[0].substring(0,inde - 1);
    inde--;
    setTimeout(dell,100);
  }
  else{
